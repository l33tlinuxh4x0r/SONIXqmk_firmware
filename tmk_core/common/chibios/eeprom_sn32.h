...
#define FEE_PAGE_BASE_ADDRESS (FEE_LAST_PAGE_ADDRESS - (FEE_MCU_FLASH_SIZE * FEE_DENSITY_PAGES))
#define FEE_DENSITY_BYTES ((FEE_PAGE_SIZE * FEE_DENSITY_PAGES) - FEE_LAST_PAGE_ADDRESS)
#define FEE_ADDR_OFFSET(Address) (Address * 2)
#define FEE_EMPTY_WORD ((uint16_t)0xFFFF)

//#define FEE_PAGE_BASE_ADDRESS ((uint32_t)(0x0000FF80 + FEE_MCU_FLASH_SIZE * 1024 - FEE_DENSITY_PAGES * FEE_PAGE_SIZE))
